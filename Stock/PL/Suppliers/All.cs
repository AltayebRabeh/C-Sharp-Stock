...
namespace Stock.PL.Suppliers
{
    public partial class All : Form
    {
        ...
        private void btn_del_Click(object sender, EventArgs e)
        {
            if (dgv.Rows.Count > 0)
            {
                ...
                if(dr == DialogResult.Yes) {
                    int i = BL.Suppliers.Delete(int.Parse(dgv.CurrentRow.Cells[0].Value.ToString()));
                    All_Activated(null, null);
                    MessageBox.Show("نم حذف عدد " + i + " من الموردين");
                }
            }
        ...
        private void btn_update_Click(object sender, EventArgs e)
        {
            ...
            frm.S_ID = int.Parse(dgv.CurrentRow.Cells[0].Value.ToString());
